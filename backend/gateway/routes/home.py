...
from ...infra.container import connection_cache_store, deploy_config_store, session_store, templates
from ..support import build_connection_summary_label, get_session, hydrate_session_last_config_from_cache, is_session_connected
...
def index(request: Request):
    ...
    if saved_connections:
        current_config = session_store.get_last_config(session)
    ...
    form_defaults = {
        **dict(session_store.get_last_config(session) or {}),
